        ...
        <form action="{{route('logined')}}" method="post">
            ...
            <div class="form-group">
                ...
                <div class="input-icon">
                    ...
                    <input class="form-control required" type="text" value="{{old('name')}}" autocomplete="off" placeholder="Tên tài khoản" name="name" id="username" autofocus >
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="input-icon">
                    ...
                    <input class="form-control required" type="password" value="{{old('password')}}" autocomplete="off" placeholder="Password" name="password" id="password"/>
                </div>
            </div>
