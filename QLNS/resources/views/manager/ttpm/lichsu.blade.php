        ...
        <div class="col-md-12">
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">
                        <b>LỊCH SỬ THEO DÕI PHẦN MỀM: {{$tenpm}}</b>
                    </div>
                    <div class="actions">
                            <a type="button" href="{{route('ttpm.index')}}" id="_btnaddPB" class="btn btn-default btn-xs" ><i
                            ...
                            @if (isset($model))
                                @foreach ($model as $key => $value)
                                    <tr>
                                        ...
                                        <td name="diengiai">{{ \Carbon\Carbon::parse($value->thoigiancapnhat)->format('H:i:s d/m/Y') }}</td>
